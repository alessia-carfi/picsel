<div class="post">
    <div class="poster">
        <img src="./giulia/prova.png" alt="" name="profileimg" id="profileimg" />
        <p class="user-tag">
            <span class="username" name="username-post" id="username-post">Franchino</span>
            <span name="tag" id="tag">@franchino09</span>
        </p>
    </div>
    <p>Ho cambiato immagine di profilo! :D</p>
    <img src="./giulia/prova.png" alt="" id="postimg" name="postimg" />
